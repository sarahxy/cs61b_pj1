...
public class RunIterator implements Iterator {
   ...
   */
  private DList2 iterator;
  private DListNode2 iteratornode;
  ...
  public int[] next() {
    ...
    curr[0] = iteratornode.numruns;
    curr[1] = iteratornode.color[0];
    curr[2] = iteratornode.color[1];
    curr[3] = iteratornode.color[2];
